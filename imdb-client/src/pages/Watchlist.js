                        ...
                        <p key={movie.id}>
                            {
                                movie.users.map(user => (
                                    user.id == user_id ?
                                        <p>
                                            {
                                                user.pivot.watchlist == 1 ? <ul className='list-group'>
                                                    {
                                                        <li className='list-group-item'>

                                                            <p><h3>{movie.title}</h3><h3><FaStar className="star mr-2"
                                                                size={25} color="ffc107" />{movie.avg_rating}</h3></p>
...
export default connect(mapStateToProps, { loadMovies, logout })(Watchlist)